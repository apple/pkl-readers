:uri-github-issue-pkl: https://github.com/apple/pkl-readers/issues/new
:uri-seven-rules: https://cbea.ms/git-commit/#seven-rules

= Pkl Readers Contributors Guide
...
Pkl Readers is released under the Apache 2.0 license.
...
* Format `.pkl` files in your PR with `pkl format apply`.
